...
const Productcard = ({ product }) => {
  const { currency, updateCartItem, addToCart, removeFromCart,navigate,cartItems } =
    useAppContext();
  const [count, setCount] =useState(0)


  return product && (
    <div className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-60 w-full">
